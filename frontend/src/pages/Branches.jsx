              ...
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-lg bg-[#00a79d]/10 flex items-center justify-center">
        ...
        <DialogContent>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-[#00a79d] hover:bg-[#008f86]" data-testid="save-branch-btn">
