          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 bg-gray-50 border-gray-200 rounded-full focus:ring-[#00a79d] focus:border-[#00a79d]"
                required
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 h-12 bg-gray-50 border-gray-200 rounded-full focus:ring-[#00a79d] focus:border-[#00a79d]"
                required
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[#00a79d] hover:bg-[#008f86] text-white font-semibold rounded-full shadow-md transition-all duration-200"
